class Miner:
    ...
    # Time to travel from the validator to the miner by using ICMP ping
    routing_time: float = 0
    # Time for the subtensor to resolve its challenge
    ...
    def __init__(
        ...
        self.performance_score = float(performance_score or 0)
        ...
        self.routing_time = float(routing_time or 0)

    def reset(self, ip, hotkey, subregion, country):
        self.hotkey = hotkey
        self.ip = ip
        self.version = "0.0.0"
        self.subregion = subregion or ""
    ...
    def __str__(self):
        return f"Miner(uid={self.uid}, hotkey={self.hotkey}, ip={self.ip}, ip_occurences={self.ip_occurences}, version={self.version}, subregion={self.subregion}, country={self.country}, verified={self.verified}, sync={self.sync}, suspicious={self.suspicious}, penalty_factor={self.penalty_factor}, score={self.score}, availability_score={self.availability_score}, latency_score={self.latency_score}, performance_score={self.performance_score}, reliability_score={self.reliability_score}, distribution_score={self.distribution_score}, challenge_attempts={self.challenge_attempts}, challenge_successes={self.challenge_successes}, process_time={self.process_time}, routing_time={self.routing_time})"
    ...
    def __eq__(self, other):
        if isinstance(other, Miner):
            return (
                ...
                and self.subregion == other.subregion
                ...
                and self.routing_time == other.routing_time
